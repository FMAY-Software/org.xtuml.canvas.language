...
public class CanvasParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, CanvasGrammarAccess grammarAccess) {
			builder.put(grammarAccess.getModelRenderAccess().getAlternatives_0(), "rule__ModelRender__Alternatives_0");
			...
			builder.put(grammarAccess.getModelPropertiesAccess().getAlternatives_3(), "rule__ModelProperties__Alternatives_3");
			...
			builder.put(grammarAccess.getShapeAccess().getAlternatives_4(), "rule__Shape__Alternatives_4");
			...
			builder.put(grammarAccess.getEnumEndAccess().getAlternatives_0(), "rule__EnumEnd__Alternatives_0");
			builder.put(grammarAccess.getEnumEndAccess().getWhereAlternatives_1_0(), "rule__EnumEnd__WhereAlternatives_1_0");
			...
			builder.put(grammarAccess.getConnectorAccess().getAlternatives_2(), "rule__Connector__Alternatives_2");
			...
			builder.put(grammarAccess.getSegmentAccess().getAlternatives_1(), "rule__Segment__Alternatives_1");
			builder.put(grammarAccess.getSegmentAccess().getAlternatives_3(), "rule__Segment__Alternatives_3");
			builder.put(grammarAccess.getPointDefinitionAccess().getAlternatives_0(), "rule__PointDefinition__Alternatives_0");
			...
			builder.put(grammarAccess.getModelRenderAccess().getGroup_0_0(), "rule__ModelRender__Group_0_0__0");
			...
			builder.put(grammarAccess.getModelPropertiesAccess().getGroup_3_0(), "rule__ModelProperties__Group_3_0__0");
			...
			builder.put(grammarAccess.getShapeAccess().getGroup_4_0(), "rule__Shape__Group_4_0__0");
			...
			builder.put(grammarAccess.getEnumEndAccess().getGroup_0_0(), "rule__EnumEnd__Group_0_0__0");
			...
			builder.put(grammarAccess.getConnectorAccess().getGroup_2_0(), "rule__Connector__Group_2_0__0");
			...
			builder.put(grammarAccess.getSegmentAccess().getGroup_1_0(), "rule__Segment__Group_1_0__0");
			builder.put(grammarAccess.getSegmentAccess().getGroup_3_0(), "rule__Segment__Group_3_0__0");
			...
			builder.put(grammarAccess.getPointDefinitionAccess().getGroup_0_0(), "rule__PointDefinition__Group_0_0__0");
			...
			builder.put(grammarAccess.getModelRenderAccess().getImportURIAssignment_1(), "rule__ModelRender__ImportURIAssignment_1");
			...
			builder.put(grammarAccess.getShapeAccess().getContainerAssignment_3(), "rule__Shape__ContainerAssignment_3");
			builder.put(grammarAccess.getShapeAccess().getRepresentsAssignment_5(), "rule__Shape__RepresentsAssignment_5");
			builder.put(grammarAccess.getShapeAccess().getRectAssignment_6(), "rule__Shape__RectAssignment_6");
			builder.put(grammarAccess.getShapeAccess().getTextAssignment_7(), "rule__Shape__TextAssignment_7");
			...
			builder.put(grammarAccess.getFloatingTextAccess().getEndAssignment_3(), "rule__FloatingText__EndAssignment_3");
			builder.put(grammarAccess.getEnumEndAccess().getWhereAssignment_1(), "rule__EnumEnd__WhereAssignment_1");
			...
			builder.put(grammarAccess.getConnectorAccess().getRepresentsAssignment_3(), "rule__Connector__RepresentsAssignment_3");
			builder.put(grammarAccess.getConnectorAccess().getPolylineAssignment_4(), "rule__Connector__PolylineAssignment_4");
			builder.put(grammarAccess.getConnectorAccess().getAnchorsAssignment_5(), "rule__Connector__AnchorsAssignment_5");
			builder.put(grammarAccess.getConnectorAccess().getTextsAssignment_6(), "rule__Connector__TextsAssignment_6");
			...
			builder.put(grammarAccess.getSegmentAccess().getStartPointAssignment_2(), "rule__Segment__StartPointAssignment_2");
			builder.put(grammarAccess.getSegmentAccess().getEndPointAssignment_4(), "rule__Segment__EndPointAssignment_4");
			...
			builder.put(grammarAccess.getPointDefinitionAccess().getXAssignment_2(), "rule__PointDefinition__XAssignment_2");
			builder.put(grammarAccess.getPointDefinitionAccess().getYAssignment_4(), "rule__PointDefinition__YAssignment_4");
