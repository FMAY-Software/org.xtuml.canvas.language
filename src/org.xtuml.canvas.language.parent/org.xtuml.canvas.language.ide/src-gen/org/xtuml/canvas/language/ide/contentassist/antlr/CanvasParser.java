...
public class CanvasParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, CanvasGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getShapeAccess().getAlternatives_6(), "rule__Shape__Alternatives_6");
			...
			builder.put(grammarAccess.getEnumEndAccess().getAlternatives(), "rule__EnumEnd__Alternatives");
			...
			builder.put(grammarAccess.getConnectorAccess().getAlternatives_6(), "rule__Connector__Alternatives_6");
			...
			builder.put(grammarAccess.getShapeAccess().getGroup_6_0(), "rule__Shape__Group_6_0__0");
			...
			builder.put(grammarAccess.getConnectorAccess().getGroup_6_0(), "rule__Connector__Group_6_0__0");
			...
			builder.put(grammarAccess.getShapeAccess().getTextAssignment_5(), "rule__Shape__TextAssignment_5");
			builder.put(grammarAccess.getShapeAccess().getRepresentsAssignment_7(), "rule__Shape__RepresentsAssignment_7");
			...
			builder.put(grammarAccess.getConnectorAccess().getTextsAssignment_5(), "rule__Connector__TextsAssignment_5");
			builder.put(grammarAccess.getConnectorAccess().getRepresentsAssignment_7(), "rule__Connector__RepresentsAssignment_7");
