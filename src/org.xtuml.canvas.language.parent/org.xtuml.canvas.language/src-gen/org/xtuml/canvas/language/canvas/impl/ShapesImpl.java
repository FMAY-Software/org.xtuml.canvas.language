 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtuml.canvas.language.canvas.impl.ShapesImpl#getShapes <em>Shapes</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ShapesImpl extends GraphicalElementImpl implements Shapes
{
  /**
  ...
  {
    return CanvasPackage.Literals.SHAPES;
  }
  ...
  public EList<Shape> getShapes()
  {
    if (shapes == null)
    {
      shapes = new EObjectContainmentEList<Shape>(Shape.class, this, CanvasPackage.SHAPES__SHAPES);
    }
    return shapes;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case CanvasPackage.SHAPES__SHAPES:
